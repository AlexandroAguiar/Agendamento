...
import br.com.alexcorp.agendamento.dao.UsuarioDAO;
...
public class UsuarioController {
	 ...
	 * vindo no corpo da requisicao através do método POST Este método POST é o que
	 * permite ao FRONT END enviar dados para o BACK END
	 */
	@PostMapping("/login")
